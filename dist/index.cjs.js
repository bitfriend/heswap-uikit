...
var RotatingHeswapIcon = styled__default['default'](Icon$r)(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var FloatingPanIcon = styled__default['default'](Icon$s)(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var ModalCloseButton = function (_a) {
    ...
    return (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog", width: "24px", height: "24px" },
        React__default['default'].createElement(Icon$1g, { color: theme.menu.leftBarColor })));
};
    ...
    return (React__default['default'].createElement(ModalContainer, __assign({ minWidth: minWidth }, props),
        React__default['default'].createElement(ModalHeader, { background: getThemeValue("colors." + headerBackground, headerBackground)(theme) },
            React__default['default'].createElement(ModalTitle, null,
                ...
                React__default['default'].createElement(Heading, { color: theme.menu.topBarColor }, title)),
...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 47.001 47.001" }, props),
        React__default['default'].createElement("path", { d: "M44.845,42.718H2.136C0.956,42.718,0,43.674,0,44.855c0,1.179,0.956,2.135,2.136,2.135h42.708 c1.18,0,2.136-0.956,2.136-2.135C46.979,43.674,46.023,42.718,44.845,42.718z" }),
        React__default['default'].createElement("path", { d: "M4.805,37.165c-1.18,0-2.136,0.956-2.136,2.136s0.956,2.137,2.136,2.137h37.37c1.18,0,2.136-0.957,2.136-2.137 s-0.956-2.136-2.136-2.136h-0.533V17.945h0.533c0.591,0,1.067-0.478,1.067-1.067s-0.478-1.067-1.067-1.067H4.805 c-0.59,0-1.067,0.478-1.067,1.067s0.478,1.067,1.067,1.067h0.534v19.219H4.805z M37.37,17.945v19.219h-6.406V17.945H37.37z M26.692,17.945v19.219h-6.406V17.945H26.692z M9.609,17.945h6.406v19.219H9.609V17.945z" }),
        React__default['default'].createElement("path", { d: "M2.136,13.891h42.708c0.007,0,0.015,0,0.021,0c1.181,0,2.136-0.956,2.136-2.136c0-0.938-0.604-1.733-1.443-2.021 l-21.19-9.535c-0.557-0.25-1.194-0.25-1.752,0L1.26,9.808c-0.919,0.414-1.424,1.412-1.212,2.396 C0.259,13.188,1.129,13.891,2.136,13.891z" })));
};

var Icon$p = function (props) { return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 507.925 507.925" }, props),
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement(Flex, { className: "desktop-icon", justifyContent: "center", alignItems: "center" },
            React__default['default'].createElement(Icon$15, { marginRight: isPushed ? '24px' : 0 }),
    ...
    return (React__default['default'].createElement(Container, { style: {
        ...
        React__default['default'].createElement(RowWrapper, { style: { marginBottom: '16px' } },
            React__default['default'].createElement(IconWrapper, null,
                React__default['default'].createElement(Icon$1v, { color: theme.colors.backgroundAlt })),
...
exports.HeswapRoundIcon = Icon$V;
exports.HeswapToggle = HeswapToggle;
exports.HeswapsIcon = Icon$W;
