...
var Panel = function (props) {
    var _a;
    var isDark = props.isDark, isPushed = props.isPushed, pushNav = props.pushNav, links = props.links;
    // Find the home link if provided
    var homeLink = links.find(function (link) { return link.label === "Home"; });
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed },
        React__default['default'].createElement(StyledLogo, { isPushed: isPushed, togglePush: function () { return pushNav(!isPushed); }, isDark: isDark, href: (_a = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _a !== void 0 ? _a : "/" }),
