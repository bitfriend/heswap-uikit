...
var StyledFlex = styled(Flex)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  padding-top: 7px;\n  padding-bottom: 7px;\n"], ["\n  padding-top: 7px;\n  padding-bottom: 7px;\n"])));
var blink = keyframes(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  0%,  100% { transform: scaleY(1); } \n  50% { transform:  scaleY(0.1); } \n"], ["\n  0%,  100% { transform: scaleY(1); } \n  50% { transform:  scaleY(0.1); } \n"])));
...
var Logo = function (_a) {
    ...
    return (React.createElement(StyledFlex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(HamburgerCloseIcon, { width: "24px", style: { fill: '#fff' } })) : (React.createElement(HamburgerIcon, { width: "24px", style: { fill: '#fff' } }))),
